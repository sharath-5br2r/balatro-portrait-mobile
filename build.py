...
def _sign_apk(signer):
    ...
    if ks_path and os.path.exists(ks_path) and ks_pass and ks_alias:
        ...
        _java(signer, args)
        shutil.move(os.path.join(WORKDIR,"balatro-aligned-signed.apk"), os.path.join(WORKDIR,"balatro-portrait-mobile.apk"))
    else:
        ...
        shutil.move(os.path.join(WORKDIR,"balatro-aligned-debugSigned.apk"), os.path.join(WORKDIR,"balatro-portrait-mobile.apk"))
